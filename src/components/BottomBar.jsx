...
const BottomBar = () => {
  ...
  return (
    <footer className="fixed bottom-0 w-full bg-gray-100 text-center py-2 border-t border-gray-300">
      <div className="flex flex-row items-center justify-center max-w-7xl mx-auto px-4">
        <p className="text-gray-700 font-bold">&copy; {currentYear} MyPlanner. All rights reserved.</p>
